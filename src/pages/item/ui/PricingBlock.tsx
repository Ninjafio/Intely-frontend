    ...
    <section className="w-[565px]">
      ...
      <div className="mt-8 w-[448px]">
        ...
        <div className="mt-6 flex gap-6">
          <button
            type="button"
            className="inline-flex w-[212px] justify-center px-4 py-4 rounded bg-[#141414] text-white hover:bg-[#2a2a2a] transition-colors"
            onClick={onAddToCart}
          ...
          <button
            type="button"
            className="inline-flex w-[212px] justify-center px-4 py-4 rounded bg-[#ededed] text-[#141414] hover:bg-[#d4d4d4] transition-colors"
            onClick={onBuyNow}
