...
const KEY = {
	product: (id: number) => ['item', 'product', id] as const,
	related: (id: number) => ['item', 'related', id] as const,
	reviews: (id: number) => ['item', 'reviews', id] as const,
}
...
export function useRelatedProductsQuery(id: number) {
...
export function useReviewsQuery(id: number) {
